...
class ScoreAdapter(private val scoresList: List<ScoreEntry>) : RecyclerView.Adapter<ScoreAdapter.ScoreViewHolder>() {

    data class ScoreEntry(val pictureResId: Int, val name: String, val date: String, val score: Int)
